...
export const metadata: Metadata = {
  title: "Savory & Sweet Crepe Catering | Crepe L'Amour",
  description:
    "Made-to-order sweet and savory crepes from a mobile cart — plus keto, gluten-free, and vegan batters for SoCal events. Book Crepe L'Amour for weddings, showers, brunch & more.",
  openGraph: {
    title: "Savory & Sweet Crepe Catering | Crepe L'Amour",
    description:
    ...
    images: [
      {
        url: "/images/instagram/handheld-strawberry-banana-crepe.png",
  ...
  return (
    <OfferingPage
      ...
      heroImage={{
        ...
        alt: "Handheld strawberry banana crepe",
      }}
      heroImageSecondary={{
      ...
      subOfferings={[
        ...
        },
        {
          ...
          images: [
            {
              src: "/images/instagram/savory-crepe-prep.jpg",
              alt: "Savory crepe prep on the cart griddle",
            },
            {
              src: "/images/instagram/archive/organic-savory-crepe-prep.jpg",
              alt: "Organic savory crepe being prepared",
            },
            {
            ...
            },
            {
              ...
              alt: "Savory crepe cart under outdoor umbrellas",
            },
          ],
        },
      ]}
      ...
      otherFamilies={[
        {
          href: "/minis",
          label: "Mini pancakes",
          blurb: "Hello Kitty minis, buttermilk stacks, and party-ready tiny bites.",
        },
        {
          ...
          <div className="mx-auto max-w-6xl px-5 md:px-8">
            <div className="mb-10 text-center">
              ...
              <p className="mx-auto mt-3 max-w-lg text-sm leading-relaxed text-ink-soft md:text-base">
                Dietary batters so more of the guest list can get a plate — same
                cart energy, different batter. Tell us what you need when you
                book and we&apos;ll plan the line.
              </p>
            </div>
